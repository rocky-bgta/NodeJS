...
import BaseBll from "../core/baseBll";
...
export default class ExceptionLogBll extends BaseBll {
   ...
   /* public async deleteExceptionLog(id: string) {
        Util.logger('delete ExceptionLog method from userBll');
        try {
            this.exceptionLogModel = await this.dao.delete(id);//////////
        } catch (err) {
            Util.logger('Error Log', err);
            throw err;
        }
        return this.exceptionLogModel;
    }*/
